...
exports.smsg = (conn, m, store) => {
    ...
    if (m.msg) m.download = () => conn.downloadMediaMessage(m.msg)
    m.text = m.message.text || m.message.caption || m.message.conversation || m.message.contentText || m.msg.selectedDisplayText || m.msg.title || ''
    /**
